    ...
    hover:scale-110 transition duration-300 ease-in gap-3 p-4 mt-10 ml-5 rounded-xl shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] ">
      ...
      <div>
        ...
        <div className="h-[180px]">
          <img src={post.image} alt=""  className="h-full w-full md:object-cover  " />
        </div>
...

       {
        cart.some((p) => p.id === post.id) ? (<button className="text-gray-700 border-2 border-gray-700 rounded-full font-semibold 
          ...
          hover:bg-gray-700
          hover:text-white transition duration-300 ease-in" onClick={removeCart}> Remove Item 

        </button>):(<button className="text-gray-700 border-2 border-gray-700 rounded-full font-semibold 
          text-[12px] p-1 px-3 uppercase 
          hover:bg-gray-700
          hover:text-white transition duration-300 ease-in" onClick={addCart}>
                    Add To Cart
        </button>)
       }
       </div>
